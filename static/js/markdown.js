...
function initMermaid() {
  if (!window.mermaid || window.__apolloMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__apolloMermaidReady = true;
}
window.apolloInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'apollo-thinking-expanded';
