"""scripts/_lib/cli.py — shared scaffolding for the `apollo-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("apollo-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/apollo-foo`
...
VERSION = "0.1.0"  # bumped centrally; every apollo-* CLI reports this
